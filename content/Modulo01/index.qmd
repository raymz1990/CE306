...
``` {r out.width="80%", echo=FALSE} 
#| label: fig-11
#| fig-cap:  "Ilustração de limite - Trivial"

knitr::include_graphics("./img/lim1-1.png")
```
...
```{r out.width="80%", echo=FALSE} 
#| label: fig-12
#| fig-cap: "Ilustração de limite - Não trivial"

knitr::include_graphics("./img/lim2-1.png")
```
...
Considere a seguinte função não contínua em $0$, cujo gráfico é apresentado na Figura 1.13.
...
```{r out.width="80%", echo=FALSE} 
#| label: fig-13
#| fig-cap: "Ilustração de função não contínua."

knitr::include_graphics("./img/naocont-1.png")
```
...
Primeiro vamos chamar de $f(x) = 5 x^3$ e $g(x) = 4x + 3$. Agora podemos derivar cada uma destas funções em relação a $x$, ou seja, $f^{\prime}(x) = 3 \times 5 \times x^{3-1} = 15 x^2.$ De forma, similar temos $g^{\prime}(x) = 4.$ Agora usando a regra 10, temos
